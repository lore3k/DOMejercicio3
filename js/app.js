...
function crearItem(tarea, indice) {
    listaTareas.innerHTML += `<li class="list-group-item d-flex justify-content-between mx-5"><p class="m-0">${tarea}</p>
      <button class="btn btn-danger" onclick="eliminarTarea(${indice})"><i class="bi bi-trash3"></i></button></li>`;
  }
